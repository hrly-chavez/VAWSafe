    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('of_role', models.CharField(choices=[('VAWDesk', 'VAWDesk'), ('DSWD', 'DSWD'), ('Social Worker', 'Social Worker')], default=False, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sess_status', models.CharField(choices=[('Pending', 'Pending'), ('Ongoing', 'Ongoing'), ('Done', 'Done')], default='Pending')),
        ...
        migrations.AddField(
            ...
            name='vic_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shared_model.victim'),
        ),
        migrations.AddField(
