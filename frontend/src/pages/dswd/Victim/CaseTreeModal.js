                  ...
                  ? [
                      {
                        ...
                        value:
                          selectedIncident.perpetrator.per_relationship_subtype,
                      },
                    ]
                  : []),
              ]}
            ...
            <div className="divide-y divide-gray-100 mb-6">
              {[
                ...
                },
                {
                  ...
                  value: selectedIncident.incident_location,
                },
                {
                  label: "Type of Place",
                  value: selectedIncident.type_of_place,
                },
                {
                  label: "Electronic Means",
                  value: selectedIncident.electronic_means,
                },
                {
                  label: "Conflict Area",
                  value: selectedIncident.conflict_area,
                },
              ].map((item, idx) => (
                <div
                  key={idx}
