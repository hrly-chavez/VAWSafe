  ...
  const kpiCards = [
    {
      ...
      change: victimSummary.total_victims_percent ? `${victimSummary.total_victims_percent}%` : null,
      changeDirection: victimSummary.total_victims_percent > 0 ? "up" : "neutral",
    ...
    <div className="p-4 md:p-8 space-y-8 font-inter bg-[#f7f9fc]">
      ...
      <header>
        ...
        <p className="text-gray-500 mt-1">
          Track consultations, session progress, and key notifications at a glance.
        </p>
      </header>
