  //src/pages/social_worker/Sessions/WorkerCardSection.js
                ...
                >
                        ...
                        return (
                          <div
                            ...
                            className={`p-1 rounded border ${
                              time ? "bg-blue-50 text-blue-700 font-medium" : "bg-gray-100 text-gray-400"
                            }`}
                          >
                            <div className="font-semibold">{day.slice(0, 3)}</div>
                            <div>{time ? formatTo12Hour(time) : "—"}</div>
                  ...
                  <div className="border-t pt-2 mt-2 text-xs bg-gray-50 p-2 rounded">
                    ...
                    {isExpanded ? (
                      ...
                      <p className="text-gray-600">
                        {formatFriendlyDate(validUnavailable[0].start_date)} – {formatFriendlyDate(validUnavailable[0].end_date)}
                        {validUnavailable[0].reason && ` (${validUnavailable[0].reason})`}
                        {validUnavailable.length > 1 && ` +${validUnavailable.length - 1} more`}
                      </p>
                    )}
