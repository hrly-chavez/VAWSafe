// src/pages/psychometrician/Victims/SessionDetails.js
...
export default function SessionDetails({ sessionId, onClose }) {
  ...
  useEffect(() => {
    ...
    const fetchSession = async () => {
      try {
        const res = await api.get(`/api/psychometrician/sessions/${sessionId}/`);
        setSession(res.data);
      } catch (err) {
                ...
                onFeedbackUpdate={async () => {
                  try {
                    const res = await api.get(
                      `/api/psychometrician/sessions/${sessionId}/`
                    );
                    setSession(res.data);
                  } catch (err) {
