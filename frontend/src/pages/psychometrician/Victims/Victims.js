        ...
        <div className="overflow-auto max-h-[480px] rounded-xl">
          <table className="min-w-full table-fixed border border-neutral-200">
            ...
            <tbody className="text-sm text-neutral-800">
              {loading && (
                <tr>
                  <td colSpan={7} className="border border-neutral-200 px-4 py-6 text-center text-neutral-500">
                    Loading victims…
                  </td>
                </tr>
              )}
              ...
              {!loading && error && (
                <tr>
                  <td colSpan={7} className="border border-neutral-200 px-4 py-6 text-center text-red-600">
                    {error}
                  </td>
                </tr>
              )}
              ...
              {!loading && !error && filteredVictims.length === 0 && (
                <tr>
                  <td colSpan={7} className="border border-neutral-200 px-4 py-6 text-center text-neutral-500 italic">
                    No victims found.
                  </td>
                </tr>
              )}
                    ...
                    <tr key={v.vic_id} className={rowBg}>
                      ...
                      <td className="border border-neutral-200 px-4 py-3 text-center">
                        <div className="flex justify-center gap-4">
                          <Link to={`/psychometrician/victims/${v.vic_id}`} className="text-[#10b981] hover:text-[#059669]">
