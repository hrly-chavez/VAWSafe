...
const DSWDDashboard = lazy(() => import("./pages/dswd/DSWDDashboard"));
const DSWDVAWCVictims = lazy(() => import("./pages/dswd/DSWDVAWCVictims"));
const DSWDSocialWorkers = lazy(() => import("./pages/dswd/DSWDSocialWorkers"));
const DSWDCaseRecord = lazy(() => import("./pages/dswd/DSWDCaseRecord"));
const DSWDServices = lazy(() => import("./pages/dswd/DSWDServices"));
const DSWDNotification = lazy(() => import("./pages/dswd/DSWDNotification"));
const DSWDFileMaintenance = lazy(() =>
  import("./pages/dswd/DSWDFileMaintenance")
);
