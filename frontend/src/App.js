...
const BPOAppliction = lazy(() => import("./pages/desk_officer/RegisterVictim/BPOApplication"));
...
const ViewOfficials = lazy(() => import("./pages/desk_officer/SocialWorker/ViewOfficials"));
const DOAccountManagement = lazy(() => import("./pages/desk_officer/SocialWorker/AccountManagement"));
        ...
        <Suspense fallback={<div>Loading...</div>}>
          <Routes>
            ...
            >
              ...
              <Route path={ROUTES.DESK_OFFICER_BPO_APPLICATION} element={<BPOAppliction />} />
